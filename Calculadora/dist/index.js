...
var author$project$Main$cambio = function (mode) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$elemento = function (h) {
	if (h.$ === 'Just') {
		var a = h.a;
		return a;
	} else {
...
var author$project$Main$mult = F3(
	function (n, ns, fs) {
		return author$project$Main$elemento(
			elm$core$String$toInt(
				_Utils_ap(
					elm$core$String$fromChar(n),
					elm$core$String$reverse(
						elm$core$String$fromList(ns))))) * author$project$Main$elemento(
			elm$core$String$toInt(
				elm$core$String$fromList(fs)));
	});
var author$project$Main$suma = F3(
	function (n, ns, fs) {
		return author$project$Main$elemento(
			elm$core$String$toInt(
				_Utils_ap(
...
var author$project$Main$resp1 = F2(
	function (jlist, lista) {
		resp1:
		while (true) {
			var _n0 = _Utils_Tuple2(jlist, lista);
			if (!_n0.b.b) {
				return 0;
			} else {
				if (!_n0.a.b) {
					...
					if (_Utils_eq(
						...
						if (_Utils_eq(
							...
							_Utils_chr('*'))) {
							return A3(
								author$project$Main$mult,
								_Utils_chr('0'),
								_List_Nil,
								ns);
						} else {
							var $temp$jlist = A2(elm$core$List$cons, n, _List_Nil),
								$temp$lista = ns;
							jlist = $temp$jlist;
							lista = $temp$lista;
							continue resp1;
					...
					if (_Utils_eq(
						f,
						_Utils_chr('+'))) {
						return A3(author$project$Main$suma, n, ns, fs);
					} else {
						if (_Utils_eq(
							f,
							_Utils_chr('*'))) {
							return A3(author$project$Main$mult, n, ns, fs);
						} else {
							var $temp$jlist = A2(
								elm$core$List$cons,
								n,
								A2(elm$core$List$cons, f, ns)),
								$temp$lista = fs;
							jlist = $temp$jlist;
							lista = $temp$lista;
							continue resp1;
...
var author$project$Main$vista = function (modelo) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$cambio(modelo),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
